...
namespace NetCore.Services.BusinessLogic
{
    public class EmployeeServiceTDD
    {
        ...
        private EmployeeService _employeeServiceWrongForList;
        private Mock<IEmployeeRepository> _mockEmployeeRepositoryWrongForList;
        ...
        public EmployeeServiceTDD()
        {
            ...
            _mockEmployeeRepositoryWrongForList = new Mock<IEmployeeRepository>();
            _mockEmployeeRepositoryWrongForList.Setup(rep => rep.GetAllEmployees())
                .ReturnsAsync(
                new List<Employee>()
                {
                    new Employee
            ...
            _employeeServiceWrongForList = new EmployeeService(_mockEmployeeRepositoryWrongForList.Object);
        ...
        {
            var result = await _employeeServiceWrongForList.GetAll();
            Assert.Empty(result);
